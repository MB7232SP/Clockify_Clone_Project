   ...
   const navigate = useNavigate();
    ...
    return (
        <div style={{ margin: "auto" }}>
            ...
            <br />
            <br />
            <div id='HOMETIMEKEEPING' style={{ display: "flex", marginLeft: "16%" }}>
            ...
            <br />  <br />  <br /><br />
            <div id="homeTEAMACTIVITY" style={{ display: "flex", marginLeft: "16%" }}>
                <div style={{ marginTop: "100px", marginLeft: "30px" }}>
            ...
            <div style={{ marginLeft: "100px" }}>
                ...
                <div style={{ display: "flex", justifyContent:'center' }}>
                    ...
                    <div>
                        <img  src="https://clockify.me/assets/images/free-forever-clock-4.svg" alt="" style={{ height: "450px", maxWidth:"100%" }} />

                    </div>
                    <div id='homeemagetext' style={{ marginTop: "30px", marginLeft: "30px",}}>
